...
from sqlalchemy import Column, String, DateTime, Text, Date, Numeric, ForeignKey, BigInteger, Boolean
...
class Purchase(Base):
    ...
    site_id = Column(BigInteger, ForeignKey("sites.id", ondelete="SET NULL"), nullable=True)
