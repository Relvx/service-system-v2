    ...
    <div>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="s in sites" :key="s.id" class="card hover:shadow-md transition-shadow flex flex-col">
          ...
          <div class="flex gap-2 mt-auto pt-3 border-t">
            ...
            <button @click="deleteConfirm = s" class="btn bg-red-50 text-red-600 hover:bg-red-100 text-sm py-2 px-3">
      ...
      <div v-if="deleteConfirm" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 p-6">
          <h2 class="text-xl font-semibold text-gray-900 mb-2">Удалить объект?</h2>
...
import { Search, Plus, MapPin, Building2, Phone, X, Eye, Edit, Trash2 } from 'lucide-vue-next'
